...
public class Rallye {
	...
	public static void main(String[] args) {
		...
		CoPilot copilot1=new CoPilot("saad","tayeb",50,Personne.sangO2);
		Pilot pilot2=new Pilot("samir","jef",31,Personne.sangO1);
		CoPilot copilot2=new CoPilot("hanane","bezos",20,Personne.sangO2);
